...
CREATE TABLE `orders` (
  ...
  `order_status` enum('CANCELLED','DELIVERED','PLACED','SHIPPED') NOT NULL,
  `payment_deadline` datetime(6) NOT NULL,
  `payment_method` enum('CREDIT_CARD','DEBIT_CARD','NET_BANKING','UPI') DEFAULT NULL,
...
-- Dump completed on 2026-03-16 21:59:24
